...
const LEGAL = [
  ...
  "Проверка правильности оформления трудовых контрактов",
  "Помощь при нарушениях работодателем условий контракта",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground font-inter mt-4 max-w-xl mx-auto">
            Все объекты восстановления находятся под защитой органов безопасности РФ. Каждый специалист обеспечен медицинской, психологической и правовой поддержкой.
          </p>
        </div>
        ...
        {tab === "legal" && (
          <div className="max-w-2xl mx-auto bg-card border border-border rounded-2xl p-6">
            ...
            <div className="mt-6 bg-primary/5 border border-primary/20 rounded-xl p-4 text-xs font-inter text-muted-foreground">
              Форма обращения: по телефону, email или личный приём. Помощь в урегулировании споров, представительство при разрешении конфликтов, консультация юриста программы при подписании контракта.
            </div>
          </div>
        )}
      </div>
