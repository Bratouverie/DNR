...
const STEPS = [
  ...
  { icon: PenTool, num: "04", title: "Подготовка", desc: "Оформление документов и зачисление в программу" },
  { icon: Plane, num: "05", title: "Отправка на вахту", desc: "Сбор в Хабаровске или Тамбове → отправка к месту работы, подписание трудового договора" },
];
